    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">
          {loading
            ? "Loading..."
            : `${astrologers.length} astrologers awaiting approval`}
        </p>
      </div>
      ...
      {isModalOpen && selectedAstrologer && (
        <AstrologerDetailModal
          ...
          languages={
            Array.isArray(selectedAstrologer.languages)
              ? selectedAstrologer.languages.join(", ")
              : selectedAstrologer.languages
          }
          skills={
            Array.isArray(selectedAstrologer.skills)
              ? selectedAstrologer.skills.join(", ")
              : selectedAstrologer.skills
          }
